...
static_assert(LIB_EPSEON_DEBUG != 1 || LIB_EPSEON_RELEASE != 1,
              "LIB_EPSEON_DEBUG and LIB_EPSEON_RELEASE can't be both false.");
static_assert(LIB_EPSEON_DEBUG != 0 || LIB_EPSEON_RELEASE != 0,
              "LIB_EPSEON_DEBUG and LIB_EPSEON_RELEASE can't be both true.");
static_assert(LIB_EPSEON_DEBUG != 0 || LIB_EPSEON_DEBUG != 1,
              "LIB_EPSEON_DEBUG must be either 0 or 1.");
static_assert(LIB_EPSEON_RELEASE != 0 || LIB_EPSEON_RELEASE != 1,
              "LIB_EPSEON_RELEASE must be either 0 or 1.");
